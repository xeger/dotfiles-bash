...
# Ruby Enterprise Edition needs some vicious and significant hacks in order to install and to build gems.
# Let us activate the hacks when needed
function use_ree() {
  ...
  echo "All ready to experience ancient Ruby $version ..."
}
